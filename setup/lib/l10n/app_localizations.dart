...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to: **'Thicket Setup'**
  String get appTitle;

  /// Main heading on the sign-in step
  ///
  /// In en, this message translates to: **'Set up Thicket'**
  String get welcomeHeading;

  /// Description text on the sign-in step
  ///
  /// In en, this message translates to: **'Thicket gives your AI agents a persistent world model. Sign in with your
  /// Google account to register a project.'**

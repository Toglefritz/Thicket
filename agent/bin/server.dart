...
///
/// Entrypoint for the event-driven Thicket agent. Initializes Genkit with the registered world model tools, then starts
/// a Shelf HTTP server with endpoints for event processing and project registration.
library;

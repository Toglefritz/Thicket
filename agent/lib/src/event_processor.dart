...
Future<String> processEvent({
  ...
  final GenerateResponseHelper<dynamic> response = await ai.generate(
    ...
    system: 'You are Thicket Agent, an autonomous codebase learning assistant. '
        ...
        'entity properties you define). The data object MUST include a '
        '"summary" field containing a short natural-language description of '
        'what the entity represents. This field is required and is used to '
        'enable search across the world model.\n'

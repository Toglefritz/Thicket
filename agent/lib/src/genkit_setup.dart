...
///
/// This is set before each `ai.generate` call and read by the tool handlers. Genkit tools are registered at startup and
/// cannot accept per-request parameters directly, so this shared variable bridges that gap. This is safe because Cloud
/// Run processes one request at a time per instance by default.
...
Genkit initializeGenkit() {
  ...
  ai.defineTool(
    name: 'recall',
    description: 'Retrieves entities from a specified collection in the project world model. '

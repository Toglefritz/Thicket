...
///
/// This only works when the agent has filesystem access to the project (local development). On Cloud Run, this tool
/// will return a "file not found" error since the project files are not present on the server.
